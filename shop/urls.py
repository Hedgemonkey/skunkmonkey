...
from .views import (  # Cart views; Product views; Checkout and payment views; Comparison views; Order views
    AddToComparisonView, CartAddView, CartDetailView, CartRemoveView,
    CartUpdateQuantityView, CheckoutSuccessView, CheckoutView, ComparisonView,
    CreatePaymentIntentView, OrderCompleteView, OrderDetailView,
    OrderHistoryView, ProductDetailView, ProductListView,
...
urlpatterns = [
    ...
    path(
        'recover_payment_intent/<int:order_id>/',
        recover_payment_intent,
        name='recover_payment_intent'),
    ...
    path(
        'comparison/remove/<int:product_id>/',
        RemoveFromComparisonView.as_view(),
    ...
    path(
        ...
        payment_methods.attach_payment_method,
    ...
    path(
        'payment-methods/<str:payment_method_id>/set-default/',
