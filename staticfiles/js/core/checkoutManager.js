import"./apiClient.js";import{B as s}from"./baseManager.js";import{S as r}from"../shop/shopNotifications.js";/* empty css              */import"./ajax_helper.js";import"./jquery.js";import"./_commonjsHelpers.js";class n extends s{constructor(t={}){super({...t,itemType:"order",notifications:t.notifications||{displaySuccess:e=>{r.fire({title:"Success",text:e,icon:"success",confirmButtonColor:"#0d6efd"})},displayError:e=>{r.fire({title:"Error",text:e,icon:"error",confirmButtonColor:"#0d6efd"})},displaySwalError:(e,i)=>{var o;r.fire({title:"Error",text:((o=e.responseJSON)==null?void 0:o.error)||i,icon:"error",confirmButtonColor:"#0d6efd"})}}}),this.options={checkoutFormSelector:"#checkout-form",termsCheckboxSelector:"#terms-check",termsLinkSelector:"#terms-link",placeOrderButtonSelector:"#place-order-btn",...t},this.stripeElements=null,this.stripe=null,this.initEventListeners()}initEventListeners(){const t=document.querySelector(this.options.termsLinkSelector);t&&t.addEventListener("click",i=>{i.preventDefault(),this.showTermsAndConditions()});const e=document.querySelector(this.options.checkoutFormSelector);e&&e.addEventListener("submit",i=>{i.preventDefault(),this.validateAndSubmitForm(e)})}showTermsAndConditions(){r.fire({title:"Terms and Conditions",html:`
