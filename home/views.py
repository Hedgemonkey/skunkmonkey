    ...
    def get_context_data(self, **kwargs):
        ...
        try:
            ...
            context['categories'] = Category.objects.filter(
                ...
                product_count=Count('products')  # Changed from 'product' to 'products'
        ...
        try:
            if hasattr(context['request'], 'comparison_list'):
                ...
                try:
                    ...
                    logger.warning(f"Error accessing comparison_list: {str(e)}")
            ...
            logger.error(f"Error handling comparison list: {str(e)}", exc_info=True)
            context['comparison_list'] = []
