...
from typing import (
    IO, AbstractSet, Any, BinaryIO, Callable, Dict, ForwardRef, List, Mapping,
    MutableMapping, NewType, Optional, Sequence, Set, TextIO, Tuple, Type,
    TypeVar, Union,
)
...
from ._utils import (
    evaluate_forwardref, get_stacklevel, get_type_name, qualified_name,
)
...
if sys.version_info >= (3, 11):
    ...
    from typing_extensions import (
        Annotated, Any as SubclassableAny, NotRequired, TypeAlias, get_args,
        get_origin,
    )
