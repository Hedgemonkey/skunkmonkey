...
from pkg_resources import (
    BINARY_DIST, CHECKOUT_DIST, DEVELOP_DIST, EGG_DIST, SOURCE_DIST,
    Distribution, Environment, Requirement, find_distributions, normalize_path,
    parse_version, safe_name, safe_version, to_filename,
)
from setuptools.wheel import Wheel

from .unicode_utils import (
    _cfg_read_utf8_with_fallback, _read_utf8_with_fallback,
)
