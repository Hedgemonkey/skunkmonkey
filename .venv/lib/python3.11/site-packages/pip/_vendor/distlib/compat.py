...
if sys.version_info[0] < 3:  # pragma: no cover
    ...
    from urllib import (
        ContentTooShortError, pathname2url, quote as _quote, splittype,
        unquote, url2pathname, urlretrieve,
    )
    ...
    import urllib2
    from urllib2 import (
        HTTPBasicAuthHandler, HTTPError, HTTPHandler, HTTPPasswordMgr,
        HTTPRedirectHandler, Request, URLError, build_opener, urlopen,
    )
    if ssl:
    ...
    from urllib.parse import (
        quote, splittype, unquote, urljoin, urlparse, urlsplit, urlunparse,
        urlunsplit,
    )
    from urllib.request import (
        HTTPBasicAuthHandler, HTTPHandler, HTTPPasswordMgr,
        HTTPRedirectHandler, Request, build_opener, pathname2url, url2pathname,
        urlopen, urlretrieve,
    )
    if ssl:
