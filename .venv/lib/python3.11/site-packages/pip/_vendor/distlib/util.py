...
from .compat import (
    BaseConfigurator, Container, HTTPHandler, StringIO, URLError, ZipFile,
    cache_from_source, configparser, fsdecode, httplib, raw_input, shutil,
    string_types, text_type, unquote, urljoin, urlopen, urlparse, valid_ident,
    xmlrpclib,
)
...
if ssl:
    from .compat import (
        CertificateError, HTTPSHandler as BaseHTTPSHandler, match_hostname,
    )
