...
from .compat import (
    HTTPError, HTTPRedirectHandler as BaseRedirectHandler, Request, URLError,
    build_opener, pathname2url, queue, quote, text_type, unescape,
    url2pathname, urljoin, urlparse, urlunparse,
)
from .database import Distribution, DistributionPath, make_dist
from .metadata import Metadata, MetadataInvalidError
from .util import (
    ServerProxy, cached_property, ensure_slash, get_project_data,
    normalize_name, parse_name_and_version, parse_requirement, split_filename,
)
