...
import zipfile
from typing import (
    Collection, Iterable, Iterator, List, Mapping, NamedTuple, Optional,
)

from pip._internal.exceptions import (
    InvalidWheel, NoneMetadataError, UnsupportedWheel,
)
...
from .base import (
    BaseDistribution, BaseEntryPoint, BaseEnvironment, InfoPath, Wheel,
)
