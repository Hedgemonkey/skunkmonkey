# skunkmonkey/management/commands/collectstatic_s3.py
# # flake8: noqa
"""
...
from skunkmonkey.force_s3_upload import run_collectstatic_with_s3
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        if not getattr(settings, 'USE_S3', False):
            raise CommandError('AWS S3 is not enabled. Cannot proceed with S3 upload.')
        ...
        try:
            ...
            try:
                ...
                self.stdout.write(f'Storage location: {storage_instance.location}')
